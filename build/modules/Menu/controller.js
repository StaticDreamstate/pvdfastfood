...
const controller = {
    menu(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const topMenu = yield Products_1.default.find().sort({ updated_at: -1 }).limit(5);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (String(param).length > 1) {
                    const nameCheck = yield Products_1.default.find({ nome: param });
                    return res.status(200).json(nameCheck);
                }
                else {
                    const codeCheck = yield Products_1.default.find({ codigo: param });
